...
export const useGamepads = ({
  ...
  const addGamepad = useCallback((gamepad: any) => {
    ...
    document.dispatchEvent(
      new CustomEvent("gamepadupdated", {
        bubbles: true,
        cancelable: false,
        detail: { gamepad: currentGamepadState.current },
      }),
    );
  }, []);
  ...
  const updateButton = useCallback(
    (buttonIndex: any, buttonName: any, button: any) => {
      ...
      if (currentGamepadState.current.buttons[buttonName].pressed !== pressed) {
        ...
        document.dispatchEvent(
          new CustomEvent("gamepadbuttonchange", {
            ...
            cancelable: false,
            detail: {
              gamepad: currentGamepadState.current.index,
              buttonDetails,
            },
          }),
        );
        ...
        if (
          pressed &&
          !currentGamepadState.current.buttons[buttonName].pressed
        ) {
  ...
  const updateAxes = useCallback(
    (axesIndex: any, axesName: any, value: any) => {
      if (
        axesName &&
        value !== undefined &&
        value !== null &&
        ...
        if (currentGamepadState.current.axes[axesName] !== newValue) {
          ...
          if (axesName === "LeftStickX") {
            if (previousValue <= stickThreshold && newValue > stickThreshold) {
              document.dispatchEvent(
                new CustomEvent("leftStickXRight", {
                  bubbles: true,
                  detail: {
                    gamepad: currentGamepadState.current.index,
                    axes: axesDetails,
            ...
            if (previousValue >= -stickThreshold && newValue < stickThreshold) {
              document.dispatchEvent(
                new CustomEvent("leftStickXLeft", {
                  bubbles: true,
                  detail: {
                    gamepad: currentGamepadState.current.index,
                    axes: axesDetails,
          ...
          if (axesName === "LeftStickY") {
            ...
            if (previousValue >= -stickThreshold && newValue < stickThreshold) {
              document.dispatchEvent(
                new CustomEvent("leftStickYDown", {
                  bubbles: true,
                  detail: {
                    gamepad: currentGamepadState.current.index,
                    axes: axesDetails,
          ...
          if (axesName === "RightStickX") {
            if (previousValue <= stickThreshold && newValue > stickThreshold) {
              document.dispatchEvent(
                new CustomEvent("rightStickXRight", {
                  bubbles: true,
                  detail: {
                    gamepad: currentGamepadState.current.index,
                    axes: axesDetails,
            ...
            if (previousValue >= -stickThreshold && newValue < stickThreshold) {
              document.dispatchEvent(
                new CustomEvent("rightStickXLeft", {
                  bubbles: true,
                  detail: {
                    gamepad: currentGamepadState.current.index,
                    axes: axesDetails,
          ...
          if (axesName === "RightStickY") {
            ...
            if (previousValue >= -stickThreshold && newValue < stickThreshold) {
              document.dispatchEvent(
                new CustomEvent("rightStickYDown", {
                  bubbles: true,
                  detail: {
                    gamepad: currentGamepadState.current.index,
                    axes: axesDetails,
  ...
  const updateAllAxes = useCallback(
    (gamepad: Gamepad) => {
      const { axes } = gamepad;
